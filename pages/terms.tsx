...
const Terms: FC<TermsProps> = ({}) => {
  return (
    <>
      <strong>OVERVIEW</strong> <br /> This website is operated by Tellmann Cpt. Throughout the
      site, the terms “we”, “us” and “our” refer to Tellmann Cpt. Tellmann Cpt offers this website,
      ...
      <br />
      <br /> By visiting our site and/ or purchasing something from us, you engage in our “Service”
      ...
      products and services to you. <br /> <br /> <strong>
      ...
      the Terms will result in an immediate termination of your Services. <br />
      <br /> <strong>SECTION 2 - GENERAL CONDITIONS</strong> <br /> We reserve the right to refuse
      ...
      resell or exploit any portion of the Service, use of the Service, or access to the Service or
      any contact on the website through which the service is provided, without express written
      permission by us. <br /> The headings used in this agreement are included for convenience only
      ...
      <br /> Your submission of personal information through the store is governed by our Privacy
      Policy. To view our Privacy Policy. <br /> <br />{" "}
      <strong>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</strong> <br /> Occasionally there may
      be information on our site or in the Service that contains typographical errors, inaccuracies
      ...
      notice (including after you have submitted your order). <br /> We undertake no obligation to
      ...
      <br /> <br /> <strong>SECTION 12 - PROHIBITED USES</strong> <br /> In addition to other
      prohibitions as set forth in the Terms of Service, you are prohibited from using the site or
      its content: (a) for any unlawful purpose; (b) to solicit others to perform or participate in
      ...
      the personal information of others; (i) to spam, phish, pharm, pretext, spider, crawl, or
      scrape; (j) for any obscene or immoral purpose; or (k) to interfere with or circumvent the
      security features of the Service or any related website, other websites, or the Internet. We
      reserve the right to terminate your use of the Service or any related website for violating
      ...
      no case shall Tellmann Cpt, our directors, officers, employees, affiliates, agents,
      ...
      indemnify, defend and hold harmless Tellmann Cpt and our parent, subsidiaries, affiliates,
      ...
      with the laws of South Africa. <br /> <br />{" "}

  ...
  return <>
    ...
    <style jsx>{`
      ...
      .phone {
        ...
        background: linear-gradient(90deg, var(--color-grey-bg-3), var(--color-grey-bg-3)) content-box, linear-gradient(90deg, var(--color-grey-bg-3), var(--color-grey-bg-3)) border-box;
